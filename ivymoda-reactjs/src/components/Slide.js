...
function Slide() {
  const slide = async () => {
    ...
    */
      ...
      if (finalPosition - initialPosition < -680) {
        switchSlide("next", "dragging");
      } else if (finalPosition - initialPosition > 680) {
    ...
    <div>
      ...
      <div className="body">
        <div className="slider">
          ...
          <div to="/" id="prev" className="prev">
            <i className="fas fa-caret-left"></i>
          </div>
          <div to="/" id="next" className="next">
